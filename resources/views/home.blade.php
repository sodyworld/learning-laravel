...
<div class="model" :class="{'is-active':modalGeneral}">
    <div class="modal-background"></div>
    <div class="modal-content">
        <div class="content">
            <h3 class="text-center">@{{titleModal}}</h3>
            <div class="field">
                <label for="" class="label">@{{messageModal}}</label>
                <p class="control" v-if="modalDeparture!=0">
                    <input type="text" class="input" placeholder="Departamento" v-model="titleDeparture" v-if="modalDeparture==1">
                </p>
                ...
                <div class="columns button-content">
                    <div class="column">
                        <a href="" class="button is-success" @click="createDeparture()">Aceptar</a>
                    </div>
                    <div class="column">
                        <a href="" class="button is-danger" @click="closeModal()">Cancel</a>
                    </div>
                </div>
            </div>
        </div>
